...
public sealed class Board : MonoBehaviour
{
    ...
    private readonly List<Tile> _recentlySwappedTiles = new();
    ...
    public async Task Swap(Tile tile1, Tile tile2)
    {
        ...
        _recentlySwappedTiles.Add(tile1);
        _recentlySwappedTiles.Add(tile2);
    }
    ...
    {
        var tilesToProcess = new List<Tile>(_recentlySwappedTiles);
        _recentlySwappedTiles.Clear();
        ...
        foreach (var tile in tilesToProcess)
        {
            ...
            Score.Instance.ScoreBoard += tile.Item.Value * connectedTiles.Count;
        ...
        for (int y = 0; y < Height; y++)
        {
            ...
            {
                var tile = Tiles[x, y];
                if (tilesToProcess.Contains(tile)) continue;
